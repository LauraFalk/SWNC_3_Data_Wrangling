...
1. Go to the location of the [SWNC Data Wrangling Repository on GitHub](https://github.com/palacila/SWNC_3_Data_Wrangling). 
...
## 7. Data Clean-up - Change table layout

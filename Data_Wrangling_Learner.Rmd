...
Please note that this training is sequential. Errors must be resolved before continuing to the next code block.
...
# There should now be 15 observations in the dataframe
```
...
# There will still be 2 observations in the data frame
```
____________________________________________________________________________
